...
public class SteampunkScreen<T extends MachineContainerBase<?>> extends GuiScreenBase<T> {
	...
	public SteampunkScreen(T screenContainer, PlayerInventory inv, ITextComponent titleIn) {

...
public class FlotationSeparatorScreen extends GuiScreenBase<FlotationSeparatorContainer> {
	...
	public FlotationSeparatorScreen(FlotationSeparatorContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {

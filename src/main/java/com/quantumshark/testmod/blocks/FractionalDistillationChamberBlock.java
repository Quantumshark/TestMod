...
public class FractionalDistillationChamberBlock extends BlockWithGui<FractionalDistillationChamberTileEntity> {

	public FractionalDistillationChamberBlock(Properties properties) {
		super(properties);
	}

	@Override
	protected RegistryObject<TileEntityType<FractionalDistillationChamberTileEntity>> getRegistry() {
		return RegistryHandler.FRACTIONAL_DISTILLATION_CHAMBER_TILE_ENTITY;
	}

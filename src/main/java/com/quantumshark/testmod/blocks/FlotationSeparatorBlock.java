...
public class FlotationSeparatorBlock extends BlockWithGui<FlotationSeparatorTileEntity> {

	public FlotationSeparatorBlock(Properties properties) {
		super(properties);
	}

	@Override
	protected RegistryObject<TileEntityType<FlotationSeparatorTileEntity>> getRegistry() {
		return RegistryHandler.FLOTATION_SEPARATOR_TILE_ENTITY;
	}

...
public class PolymerisationChamberBlock extends BlockWithGui<PolymerisationChamberTileEntity> {

	public PolymerisationChamberBlock(Properties properties) {
		super(properties);
	}

	@Override
	protected RegistryObject<TileEntityType<PolymerisationChamberTileEntity>> getRegistry() {
		return RegistryHandler.POLYMERISATION_CHAMBER_TILE_ENTITY;
	}

...
public abstract class ConnectingBlock<T extends TileEntity> extends BlockWithTileEntityBase<T> {
    ...
    protected abstract Capability<?> getMatchCapability();
    ...
    public boolean canConnect(World world, BlockPos pos, Direction dir)
    {
		if (world != null) {
			...
			{
				return (null != ((ICapabilityProvider)tile).getCapability(getMatchCapability(), dir));
			}
		}
		return false;
    }

...
public class CatalyticCrackingChamberBlock extends BlockWithGui<CatalyticCrackingChamberTileEntity> {

	public CatalyticCrackingChamberBlock(Properties properties) {
		super(properties);
	}

	@Override
	protected RegistryObject<TileEntityType<CatalyticCrackingChamberTileEntity>> getRegistry() {
		return RegistryHandler.CATALYTIC_CRACKING_CHAMBER_TILE_ENTITY;
	}

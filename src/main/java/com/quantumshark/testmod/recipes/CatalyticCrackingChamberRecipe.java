...
public class CatalyticCrackingChamberRecipe extends MachineRecipeWithHeat {
	
	// return a new recipe of this type - used for reading recipes.
	public static class RecipeFactory implements RecipeSerializer.IRecipeFactory<CatalyticCrackingChamberRecipe> {

		@Override
		public CatalyticCrackingChamberRecipe CreateRecipe(ResourceLocation recipeId) {
			return new CatalyticCrackingChamberRecipe(recipeId);
		}
	}

	// constructor, so just match the class name
	public CatalyticCrackingChamberRecipe(ResourceLocation id) {
		super(id);
	}
	...
	public static ResourceLocation RECIPE_TYPE_ID = new ResourceLocation(TestMod.MOD_ID, "catalytic_cracking_chamber");
	...
	public IRecipeSerializer<?> getSerializer() {
		...
		return RecipeInit.CATALYTIC_CRACKING_CHAMBER_RECIPE_SERIALIZER.get();
	}	
	...
	public ItemStack getIcon() {
		...
		return new ItemStack(RegistryHandler.CATALYTIC_CRACKING_CHAMBER_BLOCK.get());
	}	
}

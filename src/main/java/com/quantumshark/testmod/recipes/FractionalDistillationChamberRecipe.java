...
public class FractionalDistillationChamberRecipe extends MachineRecipeWithHeat {
	
	// return a new recipe of this type - used for reading recipes.
	public static class RecipeFactory implements RecipeSerializer.IRecipeFactory<FractionalDistillationChamberRecipe> {

		@Override
		public FractionalDistillationChamberRecipe CreateRecipe(ResourceLocation recipeId) {
			return new FractionalDistillationChamberRecipe(recipeId);
		}
	}

	// constructor, so just match the class name
	public FractionalDistillationChamberRecipe(ResourceLocation id) {
		super(id);
	}
	...
	public static ResourceLocation RECIPE_TYPE_ID = new ResourceLocation(TestMod.MOD_ID, "fractional_distillation_chamber");
	...
	public IRecipeSerializer<?> getSerializer() {
		...
		return RecipeInit.FRACTIONAL_DISTILLATION_CHAMBER_RECIPE_SERIALIZER.get();
	}	
	...
	public ItemStack getIcon() {
		...
		return new ItemStack(RegistryHandler.FRACTIONAL_DISTILLATION_CHAMBER_BLOCK.get());
	}	
}

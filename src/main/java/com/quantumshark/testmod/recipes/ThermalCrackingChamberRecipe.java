...
public class ThermalCrackingChamberRecipe extends MachineRecipeWithHeat {
	
	// return a new recipe of this type - used for reading recipes.
	public static class RecipeFactory implements RecipeSerializer.IRecipeFactory<ThermalCrackingChamberRecipe> {

		@Override
		public ThermalCrackingChamberRecipe CreateRecipe(ResourceLocation recipeId) {
			return new ThermalCrackingChamberRecipe(recipeId);
		}
	}

	// constructor, so just match the class name
	public ThermalCrackingChamberRecipe(ResourceLocation id) {
		super(id);
	}
	...
	public static ResourceLocation RECIPE_TYPE_ID = new ResourceLocation(TestMod.MOD_ID, "thermal_cracking_chamber");
	...
	public IRecipeSerializer<?> getSerializer() {
		...
		return RecipeInit.THERMAL_CRACKING_CHAMBER_RECIPE_SERIALIZER.get();
	}	
	...
	public ItemStack getIcon() {
		...
		return new ItemStack(RegistryHandler.THERMAL_CRACKING_CHAMBER_BLOCK.get());
	}	
}

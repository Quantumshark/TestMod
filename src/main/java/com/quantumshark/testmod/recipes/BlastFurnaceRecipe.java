...
public class BlastFurnaceRecipe extends MachineRecipeWithHeat {
	...
	public static class RecipeFactory implements RecipeSerializer.IRecipeFactory<BlastFurnaceRecipe> {
		...
		@Override
		public BlastFurnaceRecipe CreateRecipe(ResourceLocation recipeId) {
			return new BlastFurnaceRecipe(recipeId);
		}
	}
	...
	public static ResourceLocation RECIPE_TYPE_ID = new ResourceLocation(TestMod.MOD_ID, "blast_furnace");
	...
	public IRecipeSerializer<?> getSerializer() {
		...
		return RecipeInit.BLAST_FURNACE_RECIPE_SERIALIZER.get();
	}	
	...
	public ItemStack getIcon() {
		...
		return new ItemStack(RegistryHandler.BLAST_FURNACE_BLOCK.get());
	}	
}
